...
Config.AndyyyCurrencySystem = true --LEAVE THIS AS TRUE. IF YOU ARE NOT USING ANDYYY'S CURRENCY SYSTEM, THEN YOU DO NOT NEED THIS VERSION OF LEGACY FUEL!!
Config.AndyyyFramework = false -- true/false - If you are just using Andyyy's money script and NOT his full framework, leave this as false. If you are using Andyyy's framework, then set this to true.
Config.AndyyyChargeEmergency = false -- true/false - true charges the player for fuel for emergency vehicles. false does not charge them and instead shows them a message that their department is being billed for their fuel.
...
Config.Strings = {
	...
	EToRefuel = "Press ~g~H ~w~to refuel vehicle",
	JerryCanEmpty = "Jerry can is empty",
	FullTank = "Tank is full",
	PurchaseJerryCan = "Press ~g~H ~w~to purchase a jerry can for ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Press ~g~H~w~to cancel the fueling",
	CancelFuelingJerryCan = "Press ~g~H ~w~to cancel the fueling",
	NotEnoughCash = "Not enough cash",
	RefillJerryCan = "Press ~g~H ~w~ to refill the jerry can for ",
